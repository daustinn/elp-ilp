<?php
require_once 'services/tipo-objetivo.service.php'; // Archivo de conexión a la base de datos

if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Llama a la función para obtener los datos del rol por ID desde tu servicio/DAO
    $rol = getTipoObjetivoById($id);

    if ($rol) {
        $nombre = $rol['nombre'];
        $descripcion = $rol['descripcion'];
    } else {
        echo "Tipo de objetivo no encontrado";
    }
}
    ...
    <div class="main-container">
        ...
        <div class="modal-content max-w-[500px] mx-auto">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualizar tipo de Objetivo</h5>
                ...
                <form action="controllers/tipo-objetivo.controller.php" method="post">
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="form-group col-span-3">
                            ...
                            <input type="text" value="<?php echo $id ?>" id="id" autofocus class="form-control" name="id" readonly>
                        </div>
                        <div class="form-group col-span-3">
                        ...
                        <div class="form-group col-span-3">
                            ...
                            <textarea type="text" id="descripcion" class="form-control" name="descripcion"><?php echo $descripcion ?></textarea>
                        </div>
                    </div>
